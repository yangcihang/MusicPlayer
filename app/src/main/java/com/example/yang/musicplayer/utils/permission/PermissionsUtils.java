package com.example.yang.musicplayer.utils.permission;
...
public class PermissionsUtils {
    ...
    static final String TAG = "PermissionsUtils";
    static final Object TRIGGER = new Object();

    PermissionsFragment mPermissionsFragment;

    public PermissionsUtils(@NonNull Activity activity) {
    ...
    private PermissionsFragment getRxPermissionsFragment(Activity activity) {
        PermissionsFragment permissionsFragment = findRxPermissionsFragment(activity);
    ...
    private Observable<Permission> request(final Observable<?> trigger, final String... permissions) {
        if (permissions == null || permissions.length == 0) {
            throw new IllegalArgumentException("PermissionsUtils.request/requestEach requires at least one input permission");
        }
    ...
    private Observable<Permission> requestImplementation(final String... permissions) {
        ...
        for (String permission : permissions) {
            ...
            PublishSubject<Permission> subject = mPermissionsFragment.getSubjectByPermission(permission);
